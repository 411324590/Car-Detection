...
def generate_colors(class_names):
    ...
    random.seed(10)  # Fixed seed for consistent colors across runs.
...
def draw_boxes(image, out_scores, out_boxes, out_classes, class_names, colors):
    ...
    font = ImageFont.truetype(font='model_data/FiraMono-Medium.otf',size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
